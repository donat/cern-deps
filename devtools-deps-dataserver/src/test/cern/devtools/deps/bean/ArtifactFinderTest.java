 ...
 *
 * The repository.xml is located in the classpath://res/repository.xml file. <p>
 * 
...
public class ArtifactFinderTest {
    ...
    public String repositoryXmlContent() throws IOException {
        InputStream repoxmlStream = ClassLoader.getSystemClassLoader().getResourceAsStream("res/repository.xml");
