 ...
 */
public class CmmnbuildArtifactDescriptor implements Comparable<CmmnbuildArtifactDescriptor>, ArtifactDescriptor {
    private final String name;
    private final String version;
    private final String jarPath;
    private final String containingFolders;
    private final List<ArtifactDescriptor> referencedArtifacts;
     ...
     */
    public CmmnbuildArtifactDescriptor(String name, String version, String jarPath, String containingFolders) {
        this.name = name;
        this.version = version;
        this.jarPath = jarPath;
        this.containingFolders = containingFolders;
        this.referencedArtifacts = new LinkedList<ArtifactDescriptor>();
        this.link = null;
    }

    public CmmnbuildArtifactDescriptor(String name, String version, String jarPath, String containingFolders,
            String link, List<ArtifactDescriptor> referencedArtifacts) {
        this.name = name;
        this.version = version;
        this.jarPath = jarPath;
        this.containingFolders = containingFolders;
    ...
    /**
     * @return Returns the referencedArtifacts.
     */
    public List<ArtifactDescriptor> getReferencedArtifacts() {
        return referencedArtifacts;
    }

    /**
     * 
     * @return null, PRO, DEV, NEXT, or "PRO,NEXT" 
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CmmnbuildArtifactDescriptor other = (CmmnbuildArtifactDescriptor) obj;
    ...
    public String toString() {
        return "CmmnbuildArtifactDescriptor [name=" + name + ", version=" + version + ", jarPath=" + jarPath
                + ", containingFolders=" + containingFolders + ", referencedArtifacts=" + referencedArtifacts
                + ", link=" + link + "]";
    }

    public int compareTo(CmmnbuildArtifactDescriptor o) {
