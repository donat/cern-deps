...
public class FullModelGeneration {
	...
	public static void main(String[] args) throws Exception {
		...
		artifacts.add(new CmmnbuildArtifactDescriptor("service", "1.0.0",
				"C:/opt/workspace/eclipse4/service-provider-framework/service.jar", ""));
		
		artifacts.add(new CmmnbuildArtifactDescriptor("client", "1.0.0",
				"C:/opt/workspace/eclipse4/service-provider-framework/client.jar", ""));
		
		artifacts.add(new CmmnbuildArtifactDescriptor("impl", "1.0.0",
				"C:/opt/workspace/eclipse4/service-provider-framework/impl.jar", ""));

		extractor.executeAnalysis(artifacts);
		db.flush("service-provider-framework.repomodel");
	}
}
