...
public class DependencyExtractorImpl implements DependencyExtractor {
	 ...
	 * 
	 * @param ad
	 *            Descriptor pointing to the jar file.
	 * @throws IOException
	 *             The file does not exist or not accessible.
	 ...
	 * 
	 * @param artifact
	 *            The descriptor to check for dependencies.
	 */
	 ...
	 * 
	 * @param artifacts
	 *            The list of artifacts where the dependencies should be discovered berween.
	 */
