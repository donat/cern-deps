...
public final class DependencyDetailsComposite extends Composite {
     ...
     */
    private final Button chkMethodIsStatic;
    ...
    private final Composite cmpClassDetails;
     ...
     */
    private final Composite cmpMethodDetails;
     ...
     */
    private final Composite cmpProductDetails;

    /**
     * Container of the product version
     */
    private final Composite cmpVersionDetails;
     ...
     */
    private final Text txtClassName;

    /**
     * Selected method's name widget.
     */
    private final Text txtMethodName;

    /**
     * Product name input field.
     */
    private final Text txtProductName;

    /**
     * Product version input field
     */
    private final Text txtProductVersions;

    /**
     * Version number input field for the version node.
     */
    private final Text txtVersion;
